...
cd new_faces/faces  %%%%%%%%%%%%%%%%%%%%%%%  this works only in the "old_faces" subdirectory
...
resize_image = @(Bitmap) imresize(Bitmap, [64 54]);
...
for i = 1:samplesize
   ...
   Resized_Im = resize_image(Image_File);
   Padded_Im = padarray(Resized_Im,[64 5]);
   ...
   Names(i, :) = Image_File_Pad;
   imwrite(Padded_Im, Image_File_Pad);
end
